...
<p class="text-4"><span class="text-white">REGISTER</span></p>
<div class="rectangle-2-5"></div>
<p class="text-6"><span class="text-white">LOGIN</span></p>
</div>
...
.rectangle-1-3 {
  ...
  background-color: rgba(18, 31, 79, 1);
}
...
@media (max-width: 768px) {
  ...
  flex-shrink: 1;
  flex-basis: auto;
  background-color: rgba(123, 168, 241, 1);
}
```
## OUTPUT:
![alt text](divi.png)
